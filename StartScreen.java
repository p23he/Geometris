...
public class StartScreen {
    ...
    public static JFrame frame = new JFrame("Geometris: Space Shooter");
    private ImagePanel panel = new ImagePanel(new ImageIcon(FILEPATH + "MenuBackground.png").getImage());
    private JLabel keyboard = new JLabel(new ImageIcon(FILEPATH + "keyboard.png"));
    ...
    public StartScreen() {
        ...
        instructionsBtn.addActionListener(new Interactions());

        startBtn.setActionCommand("play");
        exitBtn.setActionCommand("exit");
        instructionsBtn.setActionCommand("instructions");
        ...
        instructionsBtn.setFont(halogenFont.deriveFont(40f));

        title.setFont(halogenFont.deriveFont(125f));
        title.setForeground(Color.decode("#19A1BD"));
        panel.add(Box.createRigidArea(new Dimension(100, 200)));
        panel.add(title);
        panel.add(Box.createRigidArea(new Dimension(MAX_X, 200)));
        panel.add(startBtn);
    ...
    class Interactions implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (event.equals("play")) {
                ...
                JOptionPane.showMessageDialog(null, keyboard, "Instructions", JOptionPane.PLAIN_MESSAGE, null);
            }
        }
    }
}
